package ru.javacource.student.book1.frame;

import ru.javacource.student.book1.logic.Group;
import ru.javacource.student.book1.logic.ManagementSystem;
import ru.javacource.student.book1.logic.Student;
...
public class StudentsFrame extends JFrame
{
    ...
    public StudentsFrame()
    {
        ...
        SpinnerModel sm = new SpinnerNumberModel(currentYear, 1900, 2100, 1);
        ...
        Vector<Student> st = new Vector<>(ms.getAllStudents());
        // Создаем надпись
